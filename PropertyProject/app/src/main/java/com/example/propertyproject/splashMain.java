...
public class splashMain extends AppCompatActivity {
    ...
    android.widget.Button msendotpbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msendotpbutton = findViewById(R.id.sendotpbutton);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                codesent=s;
                Intent intent = new Intent(splashMain.this, otpAuthentication.class);
...
//        {
//            Intent intent = new Intent(splashMain.this, chatActivity.class);
