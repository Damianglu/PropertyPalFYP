                ...
                else
                {
                    ...
                    documentReference.update(contractor).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(getApplicationContext(), "Contractor updated successfully",Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(editContractor.this, contractorActivity.class));
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(getApplicationContext(), "Contractor could not be updated",Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(editContractor.this, contractorActivity.class));
                        }
                    });
                }
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if(documentSnapshot.exists()){
                            ...
                            mcreatecontractorarea.setText(firebasemodel1.getContractorarea());
